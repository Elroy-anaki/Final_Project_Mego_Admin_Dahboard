...
import { notifyError, notifySuccess } from '../../../lib/Toasts/Toasts';
    ...
    <div className="font-sans  min-h-screen flex items-center justify-center w-full p-4">
      <div className="w-full max-w-md bg-white shadow-2xl rounded-2xl border border-sky-100 overflow-hidden">
        ...
        >
          <div className="space-y-2 relative">
            ...
            <div className="relative">
              <input
                ...
                required
                placeholder="••••••••"
                className="w-full px-4 py-3 pr-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 transition duration-300"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            className="w-full bg-sky-900 text-white py-3 rounded-lg hover:bg-sky-800 transition duration-300 ease-in-out transform hover:scale-[1.02] shadow-md"
          >
            Reset Password
          </button>
        </form>
